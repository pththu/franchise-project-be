...
public interface CartService {
  ...
  List<CartItemResponse> getCartOnline(UUID customerId);
  ...
  void clearOnlineCart(UUID customerId);
  void removeMultipleOnlineItems(UUID customerId, List<UUID> variantIds);
}
