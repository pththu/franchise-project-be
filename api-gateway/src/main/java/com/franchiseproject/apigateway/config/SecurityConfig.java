    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
                ...
                .oauth2ResourceServer(oauth2 -> oauth2
                        .bearerTokenConverter(new CookieServerBearerTokenConverter()) // Đọc token từ Cookie/Header
                        .jwt(jwt -> jwt.jwtDecoder(reactiveJwtDecoder())) // Verify Token với Cognito
                );
