...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public PageResponse<CustomerResponse> searchAllCustomers(String keyword, CustomerStatus status, Pageable pageable) {
    ...
    @Override
    public PageResponse<CustomerResponse> searchCustomersByFranchise(UUID franchiseId, String keyword, CustomerStatus status, Pageable pageable) {
    ...
    @Override
    @Transactional
    public CustomerResponse createOrLinkCustomerAtFranchise(CreateCustomerRequest request, UUID franchiseId) {
    ...
    private PageResponse<CustomerResponse> buildPageResponse(Page<Customer> pageResult) {
        List<CustomerResponse> customerResponses = pageResult.getContent().stream()
                .map(customerMapper::toCustomerResponse)
                .toList();
