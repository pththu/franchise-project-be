...
public enum ErrorCode {
    ...
    CATEGOTY_IS_DELETED(400, "Category deleted"),
    PRODUCT_IS_DELETED(400, "Product deleted"),
    VARTIAN_IS_DELETED(400, "Variant deleted"),
    CONTAINS_PRODUCTS(400, "Cannot delete category because it contains products"),
    FORBIDDEN(403, "Access denied"),
    NOT_FOUND(404, "No Resource Found"),
    CATEGOTY_NOT_FOUND(404, "Category not found"),
